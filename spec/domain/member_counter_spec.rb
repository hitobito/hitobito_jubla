...
describe MemberCounter do
  ...
  before do
    ...
    Fabricate(Group::ChildGroup::Leader.name, group: asterix,
    ...
    Fabricate(Group::ChildGroup::Child.name, group: asterix,
      person: Fabricate(:person, gender: "w", birthday: "1999-01-01"))
    Fabricate(Group::ChildGroup::Child.name, group: asterix,
      person: Fabricate(:person, gender: "m", birthday: "1999-01-01"))
    Fabricate(Group::ChildGroup::Child.name, group: obelix,
      person: Fabricate(:person, gender: "w", birthday: "1999-02-02"))
    # external roles, not counted
    Fabricate(Group::SimpleGroup::Leader.name, group: groups(:fussball),
      person: Fabricate(:person, gender: "m", birthday: "1981-01-01"))
    Fabricate(Group::Flock::GroupAdmin.name, group: flock,
      person: Fabricate(:person, gender: "w", birthday: "1982-01-01"))
    Fabricate(Group::ChildGroup::External.name, group: obelix,
    ...
    old = Fabricate(Group::Flock::Guide.name, group: flock,
