...
describe Export::Tabular::CensusFlock do
  ...
  describe "mapped items" do
    ...
    describe "keys and values" do
      ...
      its(:values) {
        should eq ["Kanton Bern", "Stadt", "Jungwacht", "Bern", nil, nil, nil, nil, nil, false, false, false, 5, 7]
      }
    ...
    describe "contact person" do
      ...
      its(:values) {
        should eq ["Kanton Bern", "Stadt", "Jungwacht", "Bern", "Top", "Leader", nil, nil, nil, false, false, false, 5,
          7]
      }
    end
    ...
    describe "insurance attributes" do
      ...
      its(:values) {
        should eq ["Kanton Bern", "Stadt", "Jungwacht", "Bern", nil, nil, nil, nil, nil, true, true, true, 5, 7]
      }
    end
    ...
    describe "without member count" do
      ...
      its(:values) {
        should eq ["Kanton Bern", "Stadt", "Jungwacht", "Bern", nil, nil, nil, nil, nil, false, false, false, nil, nil]
      }
    end
  end
