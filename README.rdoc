...
=== Jubla Organization Hierarchy
   ...
   * Bund
      * Bund
         ...
         * Versandadresse: []
      * Bundesleitung
         * Mitglied: [:admin, :layer_full, :contact_data, :qualify]
         * Präses: [:admin, :layer_full, :contact_data, :qualify]
         * Adressverwaltung: [:group_full]
         * Ehemalig: [:group_read]
         * Extern: []
         * Versandadresse: []
      * Verbandsleitung
         ...
         * Kassier: [:contact_data, :group_read]
   ...
   * Kanton
      * Kanton
         ...
         * Versandadresse: []
      * Arbeitsstelle
         * Leitung: [:layer_full, :contact_data, :qualify]
         * Adressverwaltung: [:group_full]
         * Ehemalig: [:group_read]
         * Extern: []
         * Versandadresse: []
      * Kantonsleitung
         * Leitung: [:group_full, :layer_read, :contact_data]
         * Mitglied: [:group_read, :contact_data]
         * Stellenbegleitung: [:layer_read]
   ...
   * Region
      * Region
         ...
         * Versandadresse: []
      * Regionalleitung
         * Leitung: [:layer_full, :contact_data]
         * Mitglied: [:layer_read, :contact_data]
         * Präses: [:layer_read, :contact_data]
         * Adressverwaltung: [:group_full]
         * Ehemalig: [:group_read]
         * Extern: []
         * Versandadresse: []
   ...
   * Schar
      * Schar
         * Scharleitung: [:layer_full, :contact_data, :approve_applications]
         * Lagerleitung: [:layer_full, :contact_data]
         * Präses: [:layer_read, :contact_data]
         * Kassier: [:layer_read, :contact_data]
         * Leiter: [:layer_read]
         * Adressverwaltung: [:group_full]
         * Ehemalig: [:group_read]
         * Extern: []
