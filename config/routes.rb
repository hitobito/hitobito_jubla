...
Rails.application.routes.draw do
  ...
  get 'list_camps' => 'event/camps#index', as: :list_camps
  get 'list_all_camps' => 'event/camps#all_camps', as: :list_all_camps
  get 'list_state_camps' => 'event/camps#state_camps', as: :list_state_camps
